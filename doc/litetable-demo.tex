...
\begin{tikzpicture}[remember picture, overlay]
    ...
    \newday
    \course [color = DarkBlue, subject = expl3, teacher = The {\LaTeX} Project] {6} {8}
    \newday
    \course [color = DarkBlue, subject = xparse, teacher = The {\LaTeX} Project] {1} {2}
    \newday
    \course [color = Indigo, subject = listofitems, location = French, teacher = Christian Tellechea] {10} {12}
    \newday
    \course [color = Crimson, subject = tikz\\library: calc, teacher = The PGF/TikZ Team] {3} {5}
    \newday
    \course [subject = xcolor, weeks = Week 1 - 16, location = Germany, teacher = Dr. Uwe Kern] {8} {9}
